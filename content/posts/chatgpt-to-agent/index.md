...
分享的是一位Trae的研发工程师，主题是《从编码助手到真实工作流》。他讲了“SOLO，本身就是用 SOLO 造出来的”——93%的AI代码贡献率，超过100万行代码，AI是主力，人类做决策和监督。PPT里有一个理念让我印象很深：PPT 中提出的「Spec First, Code Next」方法论完美契合我后期摸索出的开发节奏：先让 AI 输出完整技术方案，确认整体架构无偏差后再拆分编码任务，每一个阶段设置校验节点。我此前只是无意识摸索出这套流程，而研发团队已经将其标准化。
